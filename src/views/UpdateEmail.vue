    ...
    <div class="hero-body container">
      <div class="card p-5">
        <h1 class="is-size-4 has-text-centered pb-5">
          <span v-if="isTokenValid">Email updated successfully</span>
          <span v-if="loading.emailUpdate && !isTokenValid"
            >Request not valid anymore</span
          >
        </h1>
        <b-button
  ...
  methods: {
    ...
    async updateEmail() {
      try {
        ...
        console.error(e);
        let message = "Verification token not valid";
